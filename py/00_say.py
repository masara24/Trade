#C:\Users\Administrator\AppData\Local\Programs\Python\Python312\Scripts\pip install -i https://mirrors.aliyun.com/pypi/simple pyttsx3
### english
import pyttsx3
engine = pyttsx3.init()
engine.setProperty('rate', 150)  # spead
engine.setProperty('volume', 0.9)  # volume
voices = engine.getProperty('voices')
engine.say("Hello, welcome to trade..., type zero and zero")
engine.runAndWait()
engine.stop()
